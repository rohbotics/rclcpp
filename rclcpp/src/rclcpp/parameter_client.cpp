...
SyncParametersClient::get_parameters(std::vector<std::string> parameter_names)
{
...
SyncParametersClient::get_parameter_types(std::vector<std::string> parameter_names)
{
...
SyncParametersClient::set_parameters(std::vector<rclcpp::parameter::ParameterVariant> parameters)
{
...
SyncParametersClient::list_parameters(std::vector<std::string> parameter_prefixes, uint64_t depth)
{
