...
void
Executor::add_node(rclcpp::node::Node::SharedPtr node_ptr, bool notify /* = true */)
{
...
void
Executor::remove_node(rclcpp::node::Node::SharedPtr node_ptr, bool notify /* = true */)
{
...
void
Executor::execute_timer(rclcpp::timer::TimerBase::SharedPtr timer)
{
  timer->callback_();
}

void
Executor::execute_service(rclcpp::service::ServiceBase::SharedPtr service)
{
...
void
Executor::execute_client(rclcpp::client::ClientBase::SharedPtr client)
{
...
void
Executor::wait_for_work(std::chrono::nanoseconds timeout /* = std::chrono::nanoseconds(-1) */)
{
...
Executor::get_subscription_by_handle(void * subscriber_handle)
{
  for (auto & weak_node : weak_nodes_) {
    auto node = weak_node.lock();
    if (!node) {
...
Executor::get_service_by_handle(void * service_handle)
{
  for (auto & weak_node : weak_nodes_) {
    auto node = weak_node.lock();
    if (!node) {
...
Executor::get_client_by_handle(void * client_handle)
{
  for (auto & weak_node : weak_nodes_) {
    auto node = weak_node.lock();
    if (!node) {
...
rclcpp::callback_group::CallbackGroup::SharedPtr
Executor::get_group_by_subscription(rclcpp::subscription::SubscriptionBase::SharedPtr subscription)
{
  for (auto & weak_node : weak_nodes_) {
    auto node = weak_node.lock();
    if (!node) {
...
void
Executor::get_next_subscription(AnyExecutable::SharedPtr any_exec)
{
...
rclcpp::callback_group::CallbackGroup::SharedPtr
Executor::get_group_by_service(rclcpp::service::ServiceBase::SharedPtr service)
{
  for (auto & weak_node : weak_nodes_) {
    auto node = weak_node.lock();
    if (!node) {
...
void
Executor::get_next_service(AnyExecutable::SharedPtr any_exec)
{
...
rclcpp::callback_group::CallbackGroup::SharedPtr
Executor::get_group_by_client(rclcpp::client::ClientBase::SharedPtr client)
{
  for (auto & weak_node : weak_nodes_) {
    auto node = weak_node.lock();
    if (!node) {
...
void
Executor::get_next_client(AnyExecutable::SharedPtr any_exec)
{
...
AnyExecutable::SharedPtr
Executor::get_next_executable(std::chrono::nanoseconds timeout /* = std::chrono::nanoseconds(-1) */)
{
